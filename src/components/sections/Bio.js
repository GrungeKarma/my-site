    ...
    <div id="bio">
      ...
      <div id="dual-flex">
        <div id="prof">
          <h3>Professional</h3>
          <p>
            Junior full stack web developer, motivated to find a challenging technical position where I can
            make a significant contribution. My varied work history provided me with a wide set of skills that will become an asset to anyone I work with.
          </p>
        </div>
        <div id="pers">
          <h3>Personal</h3>
